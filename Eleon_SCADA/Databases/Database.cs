...
namespace Eleon_SCADA.Logging
{
    class Databases
    {
        ...
        public Databases(Park.WindPark _park)
        {
            ...
            myDataSets = new DataSet[Eleon_SCADA.Program.myPark.NumOfTurbinesInPark + 1];
        ...
        public void Connect()
        {
            for (int i = 1; i <= _Park.NumOfTurbinesInPark; i++)
            {
                try
                {
                    ...
                    Eleon_SCADA.Settings.Database.Path + _Park.myTurbines[i].TurbineName + ".mdb";
        ...
        private void Logging()
        {
            ...
            myLogData1Timer.Interval = Eleon_SCADA.Settings.Database.SampleTime;
        ...
        private void myLogData1Timer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            if (LoggingActive && Program.myVestasController.PortIsOpen)
            {
                ...
                {
                    //LoggingActive = false;
                    Program.myAlarmDispatch.SendAnnouncement(Eleon_SCADA.Settings.AlarmAnnouncement.DefaultAddress, "Program exception\n\nDatabase - myLogData1Timer_Elapsed\n\n" + ex.Message);
...
namespace Eleon_SCADA.Logging.TableAdapters
{
