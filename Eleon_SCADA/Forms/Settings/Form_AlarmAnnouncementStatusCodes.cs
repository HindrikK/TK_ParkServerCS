...
namespace Eleon_SCADA.Forms.Settings
{
    public partial class Form_AlarmAnnouncementStatusCodes : Form
    {
        ...
        private void RefreshScreen()
        {
            ...
            for (int i = 0; i < Eleon_SCADA.Settings.AlarmAnnouncement.ExcludedStatus.Count(); i++)
            {
                uint statusCode = Eleon_SCADA.Settings.AlarmAnnouncement.ExcludedStatus[i];
        ...
        private void button_Remove_Click(object sender, EventArgs e)
        {
            ...
            {
                Eleon_SCADA.Settings.AlarmAnnouncement.RemoveExcludedStatus(listBox_ExcludedStatus.SelectedItem.ToString());
                RefreshScreen();
            }
        ...
        private void button_ClearAll_Click(object sender, EventArgs e)
        {
            ...
            {
                Eleon_SCADA.Settings.AlarmAnnouncement.ExcludedStatus.Clear();
