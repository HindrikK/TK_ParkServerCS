...
namespace TK_ParkServer.Settings
{
    static class Settings
    {
        public static System.Xml.Linq.XDocument SettingsFile;
        public static string FilePath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "TK_ParkServer\\Settings.xml");
