...
namespace TK_ParkServer.Park
{
    class WindTurbine
    {
        ...
        public const ushort statusBit_Online = 1 << 0;              // turbine is online and communicating
        public const ushort statusBit_RemoteControl = 1 << 1;       // turbine can be controlled remotely by park controller
        public const ushort statusBit_Stopped = 1 << 2;             // turbine is stopped
        public const ushort statusBit_GridConnected = 1 << 3;       // turbine is connected to the grid and producing power
        public const ushort statusBit_ServiceMode = 1 << 4;         // turbine is in service mode
        //public const ushort statusBit_Warning = 1 << 5;
        public const ushort statusBit_Error = 1 << 6;               // turbine has active error(s)
        public const ushort statusBit_LowWind = 1 << 7;             // turbine is waiting for more wind
    }
}
