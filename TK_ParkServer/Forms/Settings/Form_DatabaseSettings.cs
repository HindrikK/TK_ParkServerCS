...
namespace TK_ParkServer.Forms.Settings
{
    public partial class Form_DatabaseSettings : Form
    {
        public Form_DatabaseSettings()
        {
            ...
            textBox_Path.Text = TK_ParkServer.Settings.Database.Path;
            textBox_SampleTime.Text = TK_ParkServer.Settings.Database.SampleTime.ToString();
        }
        ...
        private void button_OK_Click(object sender, EventArgs e)
        {
            ...
            {
                TK_ParkServer.Settings.Database.Path = textBox_Path.Text;
                TK_ParkServer.Settings.Database.SampleTime = Convert.ToInt32(textBox_SampleTime.Text);
                TK_ParkServer.Settings.Database.Save();
                Dispose();
            }
            else
            {
