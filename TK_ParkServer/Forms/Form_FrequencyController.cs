...
namespace TK_ParkServer.Forms
{
    public partial class Form_FrequencyController : Form
    {
        ...
        private void LoadParameters()
        {
            ...
            PrimRegulNorm = TK_ParkServer.Settings.T01.PrimRegulNorm;
            PrimRegulEmAutoActivate = TK_ParkServer.Settings.T01.PrimRegulEmAutoActivate;
            SetpointSendRate = TK_ParkServer.Settings.T01.SetpointSendRate;
            ...
            NominalFrequency = TK_ParkServer.Settings.T01.NominalFrequency;

            textBox_NominalFrequency.Text = NominalFrequency.ToString();

            // normal mode parameters
            PrimReservePercentNorm = TK_ParkServer.Settings.T01.PrimReservePercentNorm;
            PrimReservePowerNorm = (int)(NominalPower * PrimReservePercentNorm / 100);
            DroopNorm = TK_ParkServer.Settings.T01.DroopNorm;
            DeadbandNorm = TK_ParkServer.Settings.T01.DeadbandNorm;
            ...
            // emergency mode parameters
            PrimReservePercentEm = TK_ParkServer.Settings.T01.PrimReservePercentEm;
            PrimReservePowerEm = (int)(NominalPower * PrimReservePercentEm / 100);
            DroopEm = TK_ParkServer.Settings.T01.DroopEm;
            DeadbandEm = TK_ParkServer.Settings.T01.DeadbandEm;
            MaxFreqChange = TK_ParkServer.Settings.T01.MaxFreqChange;
            MaxFreqDeviation = TK_ParkServer.Settings.T01.MaxFreqDeviation;
            PrimRegulEmResetDelay = TK_ParkServer.Settings.T01.PrimRegulEmResetDelay;
        ...
        private void SetParametersGeneral()
        {
            try
            {
                ...
                TK_ParkServer.Settings.T01.NominalFrequency = NominalFrequency;
                TK_ParkServer.Settings.T01.SetpointSendRate = SetpointSendRate;
        ...
        private void SetParametersNorm()
        {
            try
            {
                ...
                TK_ParkServer.Settings.T01.PrimReservePercentNorm = PrimReservePercentNorm;
                TK_ParkServer.Settings.T01.DroopNorm = DroopNorm;
                TK_ParkServer.Settings.T01.DeadbandNorm = DeadbandNorm;
        ...
        private void SetParametersEm()
        {
            try
            {
                ...
                TK_ParkServer.Settings.T01.PrimReservePercentEm = PrimReservePercentEm;
                TK_ParkServer.Settings.T01.DroopEm = DroopEm;
                TK_ParkServer.Settings.T01.DeadbandEm = DeadbandEm;
                TK_ParkServer.Settings.T01.MaxFreqChange = MaxFreqChange;
                TK_ParkServer.Settings.T01.MaxFreqDeviation = MaxFreqDeviation;
                TK_ParkServer.Settings.T01.PrimRegulEmResetDelay = PrimRegulEmResetDelay;
